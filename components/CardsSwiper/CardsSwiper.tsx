  ...
  (
    ...
    const animatedOverlayStyle = useAnimatedStyle(() => {
      const opacity = interpolate(
        x.value,
        [-horizontalThreshold, 0, horizontalThreshold],
        [0.5, 0, 0.5],
      );

      const backgroundColor = interpolateColor(
        x.value,
        [-horizontalThreshold, -0.3, 0, 0.3, horizontalThreshold],
        ['red', 'pink', 'transparent', 'lightblue', 'blue'],
      );
